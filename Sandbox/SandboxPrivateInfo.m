...
#define REACHABILITY_DOMAIN @"google.com"
...
+ (NSString *)pathForPrivateDocs
{
    ...
    if (!pathForPrivateDocs)
    {
        ...
        if (![[NSFileManager defaultManager] fileExistsAtPath:pathForPrivateDocs])
        {
            ...
            {
                [AKDebugger logMethod:METHOD_NAME logType:AKLogTypeError methodType:AKMethodTypeGetter tags:nil message:[NSString stringWithFormat:@"%@, %@", error, [error userInfo]]];
...
#pragma mark - // PUBLIC METHODS (Reachability) //
